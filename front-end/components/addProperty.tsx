...
type Employee = {
  ...
  propertyParkings?: number;
  propertyPrice?: number;
};
export default function AddPropertyForSell() {
  ...
  const handleOnChange = (e: any) => {
    ...
    setData({
      ...data,
      propertyCity: selectedOption?.label,
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-bold tracking-tight text-black/80 sm:text-4xl">
            Real eState
          </h2>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis
            rerum ipsum quos sequi accusamus, laborum cupiditate illo deleniti
            cum nihil?
          </p>
        </div>
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          {/* Left  Section */}
          <div className="p-8 sm:p-10 lg:flex-auto lg:border-r">
            <form>
              <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                  <h2 className="text-2xl font-semibold leading-7 text-black/80">
                  ...
                  <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 ">
                    ...
                    <div className="sm:col-span-5">
                      <label
                        ...
                        className="block text-md font-bold leading-6 text-black/80"
                      >
                        Name your property
                      </label>
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          className="block w-full rounded-md border-0 py-1.5 px-2.5 text-black/80 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        />
                      </div>
                    </div>
                    ...
                    {/* Property Type */}
                    <div className="sm:col-span-5">
                      <span className="block text-md font-bold leading-6 text-black/80">
                        ...
                        {propertyType.map((data, i) => {
                          return (
                            <div key={i} className="p-2">
                              ...
                              />
                              <label
                                htmlFor={`propertyType${i}`}
                                className="items-center justify-between w-full px-4 py-1 text-sm text-black/80 bg-white border border-gray-200 rounded-full cursor-pointer  peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100"
                              >
                                {data.name}
                              </label>
                            </div>
                        ...
                        {[1, 2, 3].map((i) => {
                          return (
                            <div key={i} className="p-2">
                              <input
                                type="radio"
                                id={`propertyParkings${i}`}
                                name="propertyParkings"
                                value={i}
                                className="hidden peer"
                                onChange={handleOnChange}
                                required
              ...
              <div className="mt-6 flex items-center justify-end gap-x-6">
                <button
                  type="button"
                  className="text-sm font-semibold leading-6 text-black/80"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="rounded-full bg-secondary px-3 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary"
                >
                  Submit for Review
                </button>
              </div>
          ...
          {/* Right  Section */}
          <div className="lg:mt-0 lg:w-full lg:max-w-xl lg:flex-shrink-0 ">
            <div className="sticky top-12 py-10 px-4 lg:px-16 text-center ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div className="relative inline-block w-full">
                <div className="shadow p-3 rounded-lg bg-white border">
                  <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                    ...
                    <div className="absolute flex justify-center bottom-0 mb-3">
                      <div className="flex bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow">
                        <p className="flex items-center font-medium text-secondary/80">
                          <svg
                  ...
                  <div className="mt-4">
                    <div className="flex justify-between">
                      {data?.propertyName ? (
                        <h2
                          className="font-medium text-base md:text-lg text-secondary/80 line-clamp-1"
                          title="New York"
                        >
                          {data?.propertyName}
                        </h2>
                      ...
                      {data?.propertyType ? (
                        <span className="flex items-center text-sm font-medium text-secondary/80">
                          <span className="flex w-2.5 h-2.5 bg-secondary rounded-full mr-1.5 flex-shrink-0"></span>
                          {propertyType[Number(data?.propertyType)]?.name}
                        </span>
                      ) : (
                        <span className="flex items-center text-sm font-medium text-secondary/80">
                          <span className="flex w-2.5 h-2.5 bg-secondary rounded-full mr-1.5 flex-shrink-0"></span>
                    ...
                    {selectedOption?.label ? (
                      <span className="flex items-center mt-2 text-sm text-secondary/80 line-clamp-1">
                  ...
                  {/* <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                    <p className="inline-flex flex-col xl:flex-row xl:items-center text-secondary/80">
                      <svg
                        className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-secondary/80"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512"
                      >
                  ...
                  <div className="grid grid-cols-2 mt-8">
                    <div className="flex items-center">
                      ...
                      <p className="ml-2 text-secondary/80 line-clamp-1">
                        Owner Address
                      </p>
                    </div>
                    ...
                    <div className="flex justify-end">
                      {data?.propertyPrice ? (
                        <p className="inline-block font-semibold text-secondary/80 whitespace-nowrap leading-tight rounded-xl">
