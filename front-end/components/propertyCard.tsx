  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 ">
      <div className="text-center my-6">
        ...
        <p>Explore our featured real estate properties</p>
      </div>
          ...
          >
            <div className="shadow p-3 rounded-lg bg-white border">
              <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                ...
                <span className="absolute top-0 left-0 inline-flex mt-3 ml-3 px-3 py-2 rounded-full z-10 bg-primary text-sm font-medium text-secondary select-none">
                  For Sale
                </span>
              </div>
              ...
              <div className="mt-4">
                ...
                <span className="flex items-center mt-2 text-sm text-secondary/80 line-clamp-1">
                  ...
                  <p title="New York, NY 10004, United States">
                    {property.location}
                  </p>
                </span>
              </div>
